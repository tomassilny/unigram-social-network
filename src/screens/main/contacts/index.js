      ...
      <View style={styles.container}>
        ...
        <View style={styles.searchUser}>
          <TextInput style={styles.searchInput}
            autoCapitalize="none"
            placeholder="Nájsť používateľov..."
        ...
        <View style={styles.dialogTypeContainer}>
          {!this.isGroupDetails &&
            <TouchableOpacity style={styles.dialogType} onPress={this.changeTypeDialog}>
              {dialogType ? <IconGroup name="group" size={25} color='#A41034' /> :
                <IconGroup name="user" size={25} color='#A41034' />
              }
              <Text style={styles.dialogTypeText}>{dialogType ? `Vytvoriť súkromný chat` : `Vytvoriť skupinový chat`}</Text>
            </TouchableOpacity>
          }
        </View>
