...
class Dialogs extends Component {
  ...
  render() {
    if (this.props.goToContacts){
      this.goToContactsScreen();
    }
        ...
        {isLoader ?
          (
            ...
            (<View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
              <Text style={{ fontSize: 19 }}>Zatiaľ žiadne chaty</Text>
            </View>
            ) :
            (
              <FlatList
...
Dialogs.propTypes = { goToContacts: PropTypes.bool };
